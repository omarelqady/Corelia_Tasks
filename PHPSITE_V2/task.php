...
<body>
    <center>
        ...
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
            ...
            <a href="logout.php" class="logout">log-out</a> <br> <br><br><br>
            <a href="delete_account.php" class="logout"> delete account?</a>
             <a href="update.php" class="logout"> update your data</a>
